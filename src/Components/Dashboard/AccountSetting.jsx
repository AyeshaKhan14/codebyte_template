        ...
        <div className="p-5">
          <div className="mb-4">
            <div className="rounded-2xl dark:bg-darkCard bg-lightCard">
              <h2 className="md:p-5 p-3 md:text-xl text-lg p-2 dark:text-white text-gray-950">
                Profile
              </h2>
                ...
                <form onSubmit={handleSocialInfoUpdate}>
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      onChange={(e) => setSocialInfo({ ...socialInfo, youtube: e.target.value })}
                  ...
                  <div className="mb-2">
                    <input
                      ...
                      onChange={(e) => setSocialInfo({ ...socialInfo, github: e.target.value })}
