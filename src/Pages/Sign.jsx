...
export const Sign = () => {
  return (
    <div className='bg-zinc-100 py-4'>
      {/* sign div */}
      <div className='shadow-2xl shadow-blue-500/50 w-[90%] bg-zinc-200 m-auto md:w-[30%] h-[600px] flex items-center justify-center'>
        <div className=' w-[85%] h-[550px] flex flex-col gap-6'>
          ...
          <div className='border-4'>
            <form className=' flex flex-col gap-6'>
              ...
              <div className='text-[#2F1CA6]'>Already have an account?</div>
            </form>
          </div>
        </div>
      </div>
