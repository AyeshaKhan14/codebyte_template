    ...
    <div>
      <div class="dark:bg-midnightBlack bg-white ">
        <div class="mx-4">
          ...
          <div>
            <section className="bg-lightcard dark:bg-darkCard relative ">
          ...
          <div className=" flex flex-col gap-24 pt-4 pb-4 md:px-8 lg:p-24">
            <div className=" bg-lightcard dark:bg-darkCard flex flex-col justify-center items-center gap-8 p-10 md:p-20  rounded-2xl relative">
